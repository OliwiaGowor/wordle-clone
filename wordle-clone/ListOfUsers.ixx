...
public:
    ...
    size_t GetSize();
    void CreateUser();
    void AddUser(std::string username, std::string password, int tmpstreak_free, int streak_daily, int wins_daily, int loses_daily, Date tmpdate);
